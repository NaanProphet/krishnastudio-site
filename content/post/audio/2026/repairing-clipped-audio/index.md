...
![Intial State](1-initial state/1a.png)
![Initial State Waveform Statistics](1-initial state/1b.png)
...
![Declip Settings with Post-limiter](2-declip with post limiter/2a.png)
![Declip Result with Post-limiter](2-declip with post limiter/2b.png)
![Declip Result with Post-limiter Waveform Statistics](2-declip with post limiter/2c.png)
...
![Declip Settings](3-declip no post limiter/3a.png)
![Declip Result](3-declip no post limiter/3b.png)
![Declip Result Waveform Statistics](3-declip no post limiter/3c.png)
