...
description: I might have a green thumb after all
date:   2019-04-10
categories: [video]
tags: [performance, "After Effects"]
---
...
* If the **Launch Gardener window** doesn't appear after launching the app, it is **probably hidden behind other windows**. Use Expose to reveal it, or click on the Python launcher in the dock. <br />![](rendergarden-2.png)
* The Launch Gardener window has **four types of Gardener nodes**.  <br />![](rendergarden-1.png)
