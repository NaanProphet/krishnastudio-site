...
description: "KeyFlow Pro, I choose you!"
date:   2018-09-24
categories: [video]
tags: [metadata]
---
...
* Roundtrips with FCP X like a boss. *Drag and drop from KeyFlow to FCP X and back.* ![KeyFlow Pro's Integration with FCP X](metadata-keyflowpro-1.png)
* For the Adobe folks, it supports Premiere exports. It can open FCP X libraries directly too.
* Subtitle import with SRT ![KeyFlow Pro's Integration with FCP X](metadata-keyflowpro-2.png)
* Generate proxy footage so you can take low res version of video files on the road!
  ![KeyFlow Pro Encoder Options](keyflowpro-encoder-options.png)
...
![DaVinci Resolve Logo](davinci-resolve-logo.png)  
...
![Red Giant Logo](red-giant-logo.png)
...
![Adobe Prelude Logo](adobe-bridge-logo.png)
...
![Checksum of video file changes after Adobe Bridge writes embedded XMP metadata](metadata-adobe-bridge.gif) 



While **[FCP X is unaffected by these embedded XMP changes]({{< relref fcpx-unaffected-by-xmp >}})**, modification of the original asset throws a major wrench in any kind of NAS/cloud archival strategy. Any type of resync will unneccessarily rewrite GBs of data for a few KB of metadata.
...
![Adobe Prelude Logo](adobe-prelude-logo.png)
...
![Exporting FCP XML with Silverstack](metadata-silverstack-export.gif) 

That's alright for me, since their yearly subscription starts at $399. 🤤

### TagSpaces (File-based)

![TagSpaces Logo](tagspaces-logo.png)
