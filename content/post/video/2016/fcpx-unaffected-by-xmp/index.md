...
description: "Goodbye fear of broken media links!"
date:   2016-01-09
categories: [video]
tags: [metadata]
---
...
![Sony XAVC-S MOV file imported into FCP X](fcp-xmp-initial-import.png)
...
![Enable Write XMP ID to Files on Import Setting in Premiere Pro](fcp-xmp-premiere-settings.png)

4. Import the same clip into Premiere Pro.

![Sony XAVC-S MOV file imported into Premiere Pro](fcp-xmp-premiere-import.png)
...
![Modified file still linked and scrubs in FCP X](fcp-xmp-great-success.png)
